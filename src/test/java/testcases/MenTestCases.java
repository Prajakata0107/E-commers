...
//	}
	...
	public void clickOnJewellery() {
		// UIKeywords.openBrowser(EnvironmentA.Browser);
		UIKeywords.LaunchUrl(EnvironmentA.URL);
		HomeTwo h = new HomeTwo();
		h.clickOnnintypercentoffbutton();
		h.clickOngenderselect();
		Waitfor.time(4);
		System.out.println("click on genderselect");
		h.clickOnWhitneckless();
		Waitfor.time(5);
		System.out.println("clickOn Neckless");
	}
