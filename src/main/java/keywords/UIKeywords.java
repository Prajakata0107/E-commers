...
public class UIKeywords {
	...
	public static List<String> getTexts(String locatorType, String locatoraValue) {
		List<WebElement> elements = getWebElements(locatorType, locatoraValue);
		List<String> texts = new ArrayList<String>();
		for (WebElement ele : elements) {
			texts.add(ele.getText());
		}
